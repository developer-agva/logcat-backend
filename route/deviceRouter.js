...
router.get('/get-payment-status/:DeviceId', deviceController.getPaymentStatus); // Get payment status for device overview button

router.put('/payment-update', deviceController.updatePaymentStatus);
router.put('/payment-update-for-email', deviceController.updatePaymentStatus2);
router.put('/update-payment-lock-status/:DeviceId', deviceController.updateDevicePaymentAndLockStatus); // Update device payment and lock status
