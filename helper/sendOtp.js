...
// send email for device lock

const sendOtpForDeviceLock = async function sendOtp(
  to,
  DeviceId,
  isPaymentDone,
  isLocked,
  ...
  try {
    ...
    tranEmailApi
      .sendTransacEmail({
        ...
        subject: "Welcome to Logcat ",
        textContent: `
                This is verification email for device lock or unlock.
                `,
        htmlContent: `
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                          ...
                          <tr>
                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                              ...
                              <h5
                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                We hope, you're having a wonderful day. Thank you for choosing AgVa Healthcare.
                                <br/>
                                ...
                                <br/>
                                  <div style="display:flex;flex-direction:column; align-item:center;">
                                    <div style="display:flex;flex-direction:column; align-item:center;">
                                      <div
                                            style="padding: 5px 10px;color: black;border-radius: 4px;">
                                        <b>
                                          DeviceId:
                                        </b>
                                        ${DeviceId}
                                      ...
                                      <a href="http://3.25.213.83:8000/devices/payment-update-for-email?DeviceId=${DeviceId}&isPaymentDone=${isPaymentDone}&isLocked=${isLocked}"
   style="width:85px;
          border:1px solid #00466a;
          background: #00466a; color: white; padding: 4px 10px; text-decoration: none;
          border-radius: 5px; margin:10px">
          ${isLocked===true?'click to unlock':'click to lock'}
</a>
                                  </div>
                                <br>
                                <h5
